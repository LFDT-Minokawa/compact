...
## [Unreleased compiler version 0.26.108 language version 0.18.2]
...
- Updates the repository to use ledger `6.1.0-alpha.3`, i.e., `@midnight-ntwrk/onchain-runtime-v1` version `1.0.0-alpha.3`.
