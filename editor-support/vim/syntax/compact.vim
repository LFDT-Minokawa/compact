...
syn keyword compactKeyword as assert circuit constructor contract default disclose enum export from import include ledger log module new pad pragma prefix pure return sealed slice struct type witness
