...
syn keyword compactKeyword as assert circuit constructor contract default disclose enum export import include ledger module pad pragma prefix pure return sealed struct witness
