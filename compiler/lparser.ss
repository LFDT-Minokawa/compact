...
(library (lparser)
  ...
  (define-language/pretty Lparser
    (terminals
      ...
      (punctuation-token (dot dotdot dotdotdot comma semicolon colon hook lparen rparen lbracket rbracket lbrace rbrace arrow sep hashmark bang amp))
      )
    (Program (p)
    ...
    (Expression (expr index)
      ...
      (place-ref src amp expr) => (place-ref expr)
    ...
    (Type (type)
      ...
      (tplace src amp type) => (tplace type)
      )
    (Type-Ref (tref)
