...
The constructor cannot call any effect-producing operations, directly or indirectly.
Any attempt to do so is a static error.  The minimal set of these operations is
`emit`, `minShielded`, `mintUnshielded`, `claimZswapCoinSpend`, `claimZswapCoinReceive`,
