...
The type parameter `PS` represents the contract's private state type.
When using these interfaces in your TypeScript use site, substitute `PS`
with the type of your contract's private state.
