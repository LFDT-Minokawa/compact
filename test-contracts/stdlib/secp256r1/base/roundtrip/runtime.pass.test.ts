...
import { MAX_SECP256R1_BASE } from '@midnight-ntwrk/compact-runtime';
...
const VALUES = [0n, 1n, 12345678901234567890n, MAX_SECP256R1_BASE];
...
export default defineRuntimeTest<typeof Contract>(
    ...
    async (Contract) => {
        ...
        for (const value of VALUES) {
            const result = (
                await contract.circuits.secp256r1_base_roundtrip(ctx, value)
            ).result;
