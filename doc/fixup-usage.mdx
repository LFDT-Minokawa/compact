...
The Compact fixup tool is part of the Compact toolchain.
It takes as input a Compact source program in a specified source file, attempts to
update the source program to account for recent changes in the Compact language,
reformats the updated program, and writes the updated and reformatted program to
the specified target file.
If a target file is not specified, the formatter writes the updated and
reformatted program to standard output.
