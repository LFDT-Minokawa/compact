...
It takes as input a Compact source program in a specified source file, reformats
the program, and writes the reformatted program to a specified target file.
If a target file is not specified, the formatter writes the reformatted program
to standard output.
