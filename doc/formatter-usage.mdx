...
title: Compact formatter usage page
sidebar_position: 3
DO NOT EDIT IN MIDNIGHT-DOCS: Changes to this file must be committed to LFDT-Minokawa/compact/doc/formatter-usage.mdx. Changing this file directly under midnight-docs will be disgarded.
---
