...
- [Primitive types](./primitive-types) - Built-in types like `Boolean`, `Uint`, `Field`, tuples, vectors, bytes, and opaque types
- [User-defined types](./user-defined-types) - Structures, enumerations, and contract types
- [Subtyping and least upper bounds](./subtyping) - Type relationships and conversions
- [Default values](./default-values) - Default values for each type
- [Representations in TypeScript](./typescript-representations) - How Compact types map to TypeScript
