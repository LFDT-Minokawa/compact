...
<table className="lang-ref-table"><tbody><tr><td><em>stmt</em>&nbsp;</td><td>&rarr;</td><td>&nbsp;&nbsp;<b><tt>if</tt></b>&nbsp;&nbsp;<b><tt>(</tt></b>&nbsp;&nbsp;<a href="#expression-sequence"><em>expr-seq</em></a>&nbsp;&nbsp;<b><tt>)</tt></b>&nbsp;&nbsp;<em>stmt</em></td></tr><tr><td>&nbsp;</td><td>|</td><td>&nbsp;&nbsp;<em>stmt<sub>0</sub></em></td></tr></tbody></table>

A block can be used in place of a single statement anywhere a single statement
is allowed, which is useful for allowing multiple statements to evaluated by the
...
Blocks can also appear in place of an expression on the right-hand side of the
arrow in an anonymous circuit, and blocks
