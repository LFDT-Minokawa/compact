...
!!!!!!!!!! TBD reorder the statement in parser and then consequently here -- Parisa
exper-seq, const, if, for, return, block and add all the section (the section for expr-seq should have a foward ref to expr-seq of expressions)
...
!!!!!!!! TBD put expression grammar up top, don't break any of it. restructure
the sections based on the semantics of cases and not the grammar grouping. e.g.,
put slice, and bytes ref in one. put arithmetic in one. put map and fold in one.
put fun in one.
