...
When present, generic arguments are also enclosed in angle brackets.
...
A compact program is a sequence of zero or more top-level program elements.

<table className="lang-ref-table"><tbody><tr><td><em>program</em>&nbsp;</td><td>&rarr;</td><td>&nbsp;&nbsp;<em>pelt</em> &mldr; <em>pelt</em>&nbsp;&nbsp;<a href="#constants"><em>eof</em></a></td></tr>
<tr><td><em>pelt</em>&nbsp;</td><td>&rarr;</td><td>&nbsp;&nbsp;<a href="#pragmas"><em>pragma-form</em></a></td></tr><tr><td>&nbsp;</td><td>|</td><td>&nbsp;&nbsp;<a href="#include-files"><em>include-form</em></a></td></tr><tr><td>&nbsp;</td><td>|</td><td>&nbsp;&nbsp;<a href="#modules-imports-and-exports"><em>module-definition</em></a></td></tr><tr><td>&nbsp;</td><td>|</td><td>&nbsp;&nbsp;<a href="#imports"><em>import-form</em></a></td></tr><tr><td>&nbsp;</td><td>|</td><td>&nbsp;&nbsp;<a href="#top-level-exports"><em>export-form</em></a></td></tr><tr><td>&nbsp;</td><td>|</td><td>&nbsp;&nbsp;<a href="#declaring-and-maintaining-public-state"><em>ledger-declaration</em></a></td></tr><tr><td>&nbsp;</td><td>|</td><td>&nbsp;&nbsp;<a href="#declaring-witnesses-for-private-state"><em>witness-declaration</em></a></td></tr><tr><td>&nbsp;</td><td>|</td><td>&nbsp;&nbsp;<a href="#contract-constructor"><em>constructor-definition</em></a></td></tr><tr><td>&nbsp;</td><td>|</td><td>&nbsp;&nbsp;<a href="#circuits"><em>circuit-definition</em></a></td></tr><tr><td>&nbsp;</td><td>|</td><td>&nbsp;&nbsp;<a href="#structure-types"><em>struct-definition</em></a></td></tr><tr><td>&nbsp;</td><td>|</td><td>&nbsp;&nbsp;<a href="#enumeration-types"><em>enum-definition</em></a></td></tr><tr><td>&nbsp;</td><td>|</td><td>&nbsp;&nbsp;<a href="#contract-types"><em>contract-declaration</em></a></td></tr><tr><td>&nbsp;</td><td>|</td><td>&nbsp;&nbsp;<a href="#type-aliases"><em>type-alias-definition</em></a></td></tr></tbody></table>

A program element can be:

- a [pragma form](#pragmas) to declare the version of the compiler and/or the language
- an [include form](#include-files) to include other Compact programs
- a [module definition](#modules-imports-and-exports) to define a Compact module
- an [import form](#imports) to import other Compact modules
- an [export form](#top-level-exports) to export top-level program elements
- a [ledger declaration](#declaring-and-maintaining-public-state) to declare a public state
- a [witness declaration](#declaring-witnesses-for-private-state) to declare a private state
- a [constructor definition](#contract-constructor) to define the contract's constructor
- a [circuit definition](#circuits) to define a circuit
- a [structure definition](#structure-types) to define a structure type
- an [enumeration definition](#enumeration-types) to define a enumeration type
- a [contract declaration](#contract-types) to declare a contract type
- a [type alias definition](#type-aliases) to define a new type
