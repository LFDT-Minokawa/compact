...
- declarations of `witness` functions, to be supplied in TypeScript, and
- `circuit` definitions, that serve as the operational core of a smart contract.

A contract can declare and import modules, and it can include code from external
files.
...
identifiers, constants, types, generic parameters, patterns, and arguments.
Then it expands on programs and program elements and opens up each of the
program elements separately. 
