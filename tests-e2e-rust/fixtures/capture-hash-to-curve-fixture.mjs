...
// Prod-18 follow-up: TS reference capture for hash_to_curve_fixture.
// See ../README.md for the capture recipe.

import { Contract } from '/tmp/hash-to-curve-driver/contract/index.js';
