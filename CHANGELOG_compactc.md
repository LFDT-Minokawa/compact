...
# Compiler Version `0.25.0`, langauge Version `0.17.0`
...
# Compiler Version `0.22.0`, language Version `0.14.0`
- address PM-15405
...
# Compiler Version `0.21.0`, language Version `0.14.0`
- address PM-8462
...
# Compiler Version `0.19.0`, Language Version `0.11.0`
- syntax changes:
  - Change `[]` for generics to `<>`
  - Change `null(T)` to `default<T>`
  - Change `map` and `fold` to look like circuit/witness calls
  - Change `Unsigned Integer` to `Uint`
  - Add `#` prefix for generic paramters that represent sizes rather than types
  - Change `Uint<<= k>` to `Uint<0..k>`
