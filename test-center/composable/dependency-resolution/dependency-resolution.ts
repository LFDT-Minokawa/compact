...
describe('Dependency resolution with contracts A-E', () => {
    ...
    test('Contract A has correct initial ledger state', () => {
        ...
        const aLedgerState = contractCodeA.ledger(aDeployed.constructorResult.currentContractState.data);
    ...
    test('Contract B references A and C correctly', () => {
        ...
        const bLedgerState = contractCodeB.ledger(bDeployed.constructorResult.currentContractState.data);
    ...
    test('Contract D references A and C correctly', () => {
        ...
        const dLedgerState = contractCodeD.ledger(dDeployed.constructorResult.currentContractState.data);
    ...
    test('Contract E references B and D correctly', () => {
        ...
        const eLedgerState = contractCodeE.ledger(eDeployed.constructorResult.currentContractState.data);
    ...
    test('Contract E.up increments counters in A and C through B and D', () => {
        ...
        const aLedgerState = contractCodeA.ledger(
            runtime.readQueryContext(result.context, aAddress).state
        );
        const cLedgerState = contractCodeC.ledger(
