...

{
  ...
  inputs = {
    ...
    zkir-v3 = {
      ...
      url = "github:midnightntwrk/midnight-ledger/JosephDenman/typed-outputs-zkir-v3"; # zkir-v3
      inputs.zkir.follows = "zkir";
    };
    zkir-v3-wasm = {
      # zkir-v3-wasm for test-center v3 support
      url = "github:midnightntwrk/midnight-ledger/JosephDenman/typed-outputs-zkir-v3";
      inputs.zkir.follows = "zkir";
    };
