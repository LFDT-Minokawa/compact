...

{
  ...
  inputs = {
    zkir = {
      ...
      url = "github:midnightntwrk/midnight-ledger/ledger-9"; # zkir-v2
    ...
    onchain-runtime-v4 = {
      ...
      url = "github:midnightntwrk/midnight-ledger/ledger-9";
      inputs.zkir.follows = "zkir";
    };
    zkir-wasm = {
    ...
    zkir-v3 = {
      ...
      url = "github:midnightntwrk/midnight-ledger/ledger-9"; # zkir-v3
      inputs.zkir.follows = "zkir";
    };
    zkir-v3-wasm = {
