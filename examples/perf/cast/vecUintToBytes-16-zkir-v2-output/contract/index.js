  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      vecToBytes: async (...args_1) => {
        ...
        if (!(Array.isArray(x_0) && x_0.length === 16 && x_0.every((t) => typeof(t) === 'bigint' && t >= 0n && t <= 255n))) {
          __compactRuntime.typeError('vecToBytes',
  ...
  async initialState(...args_0) {
    ...
    __compactRuntime.queryLedgerState(context,
                                      ...
                                      [
                                       ...
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(new Uint8Array(16)),
...
export const expectedVk = {
  'vecToBytes': '045cb0e006426b7a53ef1741ae3e22dee88b43e707c3be48b03488b342339f17',
};
