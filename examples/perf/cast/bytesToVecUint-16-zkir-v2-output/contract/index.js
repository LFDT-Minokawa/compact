...
const _descriptor_1 = new __compactRuntime.CompactTypeVector(16, _descriptor_0);
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      bytesToVec: async (...args_1) => {
        ...
        if (!(x_0.buffer instanceof ArrayBuffer && x_0.BYTES_PER_ELEMENT === 1 && x_0.length === 16)) {
          __compactRuntime.typeError('bytesToVec',
  ...
  async initialState(...args_0) {
    ...
    __compactRuntime.queryLedgerState(context,
                                      ...
                                      [
                                       ...
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(new Array(16).fill(0n)),
...
export const expectedVk = {
  'bytesToVec': '0a02191a6eef3b5f6cd64937e4d2e9fba271f838b4154dc5bf7f44a54e94e2c1',
};
