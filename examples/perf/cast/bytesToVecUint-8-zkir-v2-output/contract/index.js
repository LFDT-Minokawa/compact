  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      bytesToVec: async (...args_1) => {
        ...
        if (!(x_0.buffer instanceof ArrayBuffer && x_0.BYTES_PER_ELEMENT === 1 && x_0.length === 8)) {
          __compactRuntime.typeError('bytesToVec',
  ...
  async initialState(...args_0) {
    ...
    __compactRuntime.queryLedgerState(context,
                                      ...
                                      [
                                       ...
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(new Array(8).fill(0n)),
...
export const expectedVk = {
  'bytesToVec': 'b15fd6151fa549310c89d134bab0a1b7a20095b6ffab8e34819a13e823ca121e',
};
