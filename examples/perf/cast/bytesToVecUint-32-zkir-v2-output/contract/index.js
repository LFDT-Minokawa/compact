...
const _descriptor_1 = new __compactRuntime.CompactTypeVector(32, _descriptor_0);
  ...
  async initialState(...args_0) {
    ...
    __compactRuntime.queryLedgerState(context,
                                      ...
                                      [
                                       ...
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(new Array(32).fill(0n)),
...
export const expectedVk = {
  'bytesToVec': 'aee661716eb6e9fee4344376dd3ba5a5af30814b87547d44e1986257e10ff4a7',
};
