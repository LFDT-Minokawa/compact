...
export type Witnesses<PS> = {
  ...
  attesterSig1(context: __compactRuntime.WitnessContext<Ledger, PS>): [PS, { r: bigint,
                                                                             s: bigint
                                                                           }];
  attesterPk1(context: __compactRuntime.WitnessContext<Ledger, PS>): [PS, __compactRuntime.Secp256k1Point];
...
export declare class Contract<PS = any, W extends Witnesses<PS> = Witnesses<PS>> {
  ...
  initialState(context: __compactRuntime.ConstructorContext<PS>,
               attester0_0: Uint8Array,
               attester1_0: Uint8Array): Promise<__compactRuntime.ConstructorResult<PS>>;
}
