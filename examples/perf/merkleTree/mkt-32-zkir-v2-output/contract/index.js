...
const _descriptor_5 = new __compactRuntime.CompactTypeVector(32, _descriptor_4);
...
export class Contract {
  ...
  _findPath_0(context, partialProofData, leaf_0) {
    ...
    if (!(typeof(result_0) === 'object' && typeof(result_0.leaf) === 'bigint' && result_0.leaf >= 0 && result_0.leaf <= __compactRuntime.MAX_FIELD && Array.isArray(result_0.path) && result_0.path.length === 32 && result_0.path.every((t) => typeof(t) === 'object' && typeof(t.sibling) === 'object' && typeof(t.sibling.field) === 'bigint' && t.sibling.field >= 0 && t.sibling.field <= __compactRuntime.MAX_FIELD && typeof(t.goes_left) === 'boolean'))) {
      __compactRuntime.typeError('findPath',
                                 'return value',
                                 'merkleTreePathRoot.compact line 26 char 3',
                                 'struct MerkleTreePath<leaf: Field, path: Vector<32, struct MerkleTreePathEntry<sibling: struct MerkleTreeDigest<field: Field>, goes_left: Boolean>>>',
                                 result_0)
    }
...
export const expectedVk = {
  'verifyMembership': '0913a3cf2d1e2df85926cc8d73c8f979032a6b4203183e258fc9e758d78ca0e6',
};
