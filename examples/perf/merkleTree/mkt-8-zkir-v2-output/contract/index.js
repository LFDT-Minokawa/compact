...
export class Contract {
  ...
  _findPath_0(context, partialProofData, leaf_0) {
    ...
    if (!(typeof(result_0) === 'object' && typeof(result_0.leaf) === 'bigint' && result_0.leaf >= 0 && result_0.leaf <= __compactRuntime.MAX_FIELD && Array.isArray(result_0.path) && result_0.path.length === 8 && result_0.path.every((t) => typeof(t) === 'object' && typeof(t.sibling) === 'object' && typeof(t.sibling.field) === 'bigint' && t.sibling.field >= 0 && t.sibling.field <= __compactRuntime.MAX_FIELD && typeof(t.goes_left) === 'boolean'))) {
      __compactRuntime.typeError('findPath',
                                 'return value',
                                 'merkleTreePathRoot.compact line 26 char 3',
                                 'struct MerkleTreePath<leaf: Field, path: Vector<8, struct MerkleTreePathEntry<sibling: struct MerkleTreeDigest<field: Field>, goes_left: Boolean>>>',
                                 result_0)
    }
...
export const pureCircuits = {
  pathRootOnly: (...args_0) => {
    ...
    if (!(typeof(path_0) === 'object' && path_0.leaf.buffer instanceof ArrayBuffer && path_0.leaf.BYTES_PER_ELEMENT === 1 && path_0.leaf.length === 32 && Array.isArray(path_0.path) && path_0.path.length === 8 && path_0.path.every((t) => typeof(t) === 'object' && typeof(t.sibling) === 'object' && typeof(t.sibling.field) === 'bigint' && t.sibling.field >= 0 && t.sibling.field <= __compactRuntime.MAX_FIELD && typeof(t.goes_left) === 'boolean'))) {
...
export const expectedVk = {
  'verifyMembership': 'e5c33d448e1c16c263e26a66e49a7a6152532e3f8b51b0956d3ca26896059375',
};
